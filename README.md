...
1. **Version avec Python embarqué** : Cette version inclut tout ce dont vous avez besoin pour exécuter le programme sans installation supplémentaire. [Télécharger](https://github.com/Keryan-666/Color-Swap-ROA-2/releases/download/v1.0.4/Color_Swap_ROA_2_python.zip)

   
2. **Version sans Python** : Pour les utilisateurs ayant déjà Python installé sur leur système. [Télécharger](https://github.com/Keryan-666/Color-Swap-ROA-2/releases/download/v1.0.4/Color_Swap_ROA_2.zip) <br>
